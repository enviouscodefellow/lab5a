...
function sumArray(sumArr) {
  //eslint-disable-line
  let firstAddition = sum(sumArr[0], sumArr[1]);
  let firstElement = sum(firstAddition[0], sumArr[2]);
  // console.log(firstElement[0]);
  let secondElement = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${firstElement[0]} is their sum.`;
  // console.log(secondElement);
  let array = [firstElement[0], secondElement];
  // console.log(array);
  return array;
}
...
function multiplyArray(multArr) {
  //eslint-disable-line
  let firstMultiplication = multiply(multArr[0], multArr[1]);
  let firstElement = multiply(firstMultiplication[0], multArr[2]);
  // console.log(firstElement[0]);
